...
var _meilab$meilab$Types$PhotoGallery = {ctor: 'PhotoGallery'};
var _meilab$meilab$Types$ElmInAction = {ctor: 'ElmInAction'};
var _meilab$meilab$Types$ElmTraining = {ctor: 'ElmTraining'};
var _meilab$meilab$Types$C = {ctor: 'C'};
var _meilab$meilab$Types$IoT = {ctor: 'IoT'};
var _meilab$meilab$Types$Elixir = {ctor: 'Elixir'};
var _meilab$meilab$Types$Elm = {ctor: 'Elm'};
					...
					_0: _meilab$meilab$Views_SharedViews$styles(
						{
							...
							_0: _rtfeldman$elm_css$Css$backgroundImage(
								_rtfeldman$elm_css$Css$url(src)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _meilab$meilab$Views_Trainings$trainingView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_meilab$meilab$Messages$HideSideMenu),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				_meilab$meilab$Views_Trainings$class(
					{
						ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_meilab$meilab$Views_SharedViews$hero,
				model.currentContent.hero,
				_meilab$meilab$Views_Archives$class(
					{
						ctor: '::',
						_0: _meilab$meilab$Styles_SharedStyles$PostHero,
						_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_meilab$meilab$Views_SharedViews$hero,
				model.currentContent.hero,
				_meilab$meilab$Views_Authors$class(
					{
						ctor: '::',
						_0: _meilab$meilab$Styles_SharedStyles$PostHero,
						_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_meilab$meilab$Views_SharedViews$hero,
				model.currentContent.hero,
				_meilab$meilab$Views_Home$class(
					{
						ctor: '::',
						_0: _meilab$meilab$Styles_SharedStyles$HomePageHero,
						_1: {ctor: '[]'}
					})),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_meilab$meilab$Views_SharedViews$hero,
				model.currentContent.hero,
				_meilab$meilab$Views_About$class(
					{
						ctor: '::',
						_0: _meilab$meilab$Styles_SharedStyles$PostHero,
						_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				_meilab$meilab$Views_SharedViews$hero,
				model.currentContent.hero,
				_meilab$meilab$Views_Page$class(
					{
						ctor: '::',
						_0: _meilab$meilab$Styles_SharedStyles$PostHero,
						_1: {ctor: '[]'}
...
var _meilab$meilab$Views$view = function (model) {
	var sideMenuClass = function () {
		var _p1 = model.ui.sideMenuActive;
		if (_p1 === true) {
			return _meilab$meilab$Styles_SharedStyles$MenuActive;
		} else {
			return _meilab$meilab$Styles_SharedStyles$MenuInActive;
		}
	}();
	var contentView = function () {
		...
		switch (_p2.ctor) {
			...
			case 'TrainingRoute':
				return _meilab$meilab$Views_Trainings$trainingView(model);
			case 'AboutRoute':
